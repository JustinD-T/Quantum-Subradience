...
class SpectrumAnalyzer():
    ...
    def __init__(self, config, callback):
        ...
        try:
            ...
            print('Set data format to', config['visa'].get('data_format', 'REAL, 32'))
        ...
        try:
            ...
            print('Set center frequency to', center_freq)
            while int(self.instrument.query(self.commands['operation_complete_query'])) != 1:
                time.sleep(0.5)
        except Exception as e:
        ...
        try:
            ...
            print('Set reference level to', ref_level)
            while int(self.instrument.query(self.commands['operation_complete_query'])) != 1:
                time.sleep(0.5)
        except Exception as e:
        ...
        try:
            ...
            print('Set power unit to', power_unit)
            while int(self.instrument.query(self.commands['operation_complete_query'])) != 1:
                time.sleep(0.5)
        except Exception as e:
        ...
        try:
            ...
            print('Set number of points to', num_points)
            while int(self.instrument.query(self.commands['operation_complete_query'])) != 1:
                time.sleep(0.5)
        except Exception as e:
        ...
        try:
            ...
            print('Set auto sweep time to', auto_sweep_time)
            while int(self.instrument.query(self.commands['operation_complete_query'])) != 1:
                time.sleep(0.5)
        ...
        if config['visa'].get('auto_sweep_time', 0) != 1:
            try:
                ...
                print('Set sweep time to', sweep_time)
                while int(self.instrument.query(self.commands['operation_complete_query'])) != 1:
                    time.sleep(0.5)
            except Exception as e:
        ...
        try:
            ...
            print('Set sweep mode to', sweep_mode)
            while int(self.instrument.query(self.commands['operation_complete_query'])) != 1:
                time.sleep(0.5)
        except Exception as e:
        ...
        try:
            ...
            print('Set display_on to', display_on)
            while int(self.instrument.query(self.commands['operation_complete_query'])) != 1:
                time.sleep(0.5)
        except Exception as e:
        ...
        try:
            ...
            print('Set detector_mode to', detector_mode)
            while int(self.instrument.query(self.commands['operation_complete_query'])) != 1:
                time.sleep(0.5)
        except Exception as e:
        ...
        try:
            ...
            print('Set attenuation to', attenuation)
            while int(self.instrument.query(self.commands['operation_complete_query'])) != 1:
                time.sleep(0.5)
        except Exception as e:
        ...
        try:
            ...
            print('Set amplitude space to', amplitude_space)
            while int(self.instrument.query(self.commands['operation_complete_query'])) != 1:
                time.sleep(0.5)
        except Exception as e:
            self.log('error', f"Error setting amplitude_space to {amplitude_space}: {e}")

        # Set internal pre-amp
        try:
            pre_amp = config['visa'].get('pre_amp', 'OFF')
            self.instrument.write(self.commands['set_pre_amp'].replace('value', pre_amp))
            print('Set pre_amp to', pre_amp)
            while int(self.instrument.query(self.commands['operation_complete_query'])) != 1:
                time.sleep(0.5)
        except Exception as e:
            self.log('error', f"Error setting pre_amp to {pre_amp}: {e}")
