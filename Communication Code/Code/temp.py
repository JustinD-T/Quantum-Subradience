...
comms = visa_config['commands']
print(instrument.query('*IDN?'))
center_freq = visa_config['visa'].get("center_frequency", None)
code = comms['set_center_frequency'].replace('value', str(center_freq))
span = visa_config['visa'].get("span", None)
code2 = comms['set_span'].replace('value', str(span))
...
print(len(instrument.query(":TRACe:DATA? TRACE1").split(',')))
print(instrument.query("SWEep:POINts?"))